...
namespace PocketLedger.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PinEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    RefreshToken = table.Column<string>(type: "TEXT", nullable: true),
                    RefreshTokenExpiry = table.Column<DateTime>(type: "TEXT", nullable: false),
                    SecurityStamp2 = table.Column<string>(type: "TEXT", nullable: true),
                    TwoFactorEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    TwoFactorSecretKey = table.Column<string>(type: "TEXT", nullable: true),
                    TwoFactorRecoveryCodes = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncludeInBalance = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    DailyReminderEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    DailyReminderHour = table.Column<int>(type: "INTEGER", nullable: false),
                    WeeklySummaryEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    WeeklySummaryDay = table.Column<int>(type: "INTEGER", nullable: false),
                    MonthlySummaryEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    MonthlySummaryDay = table.Column<int>(type: "INTEGER", nullable: false),
                    BudgetAlertEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    BudgetExceededEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetAlerts = table.Column<bool>(type: "INTEGER", nullable: false),
                    WeeklyReport = table.Column<bool>(type: "INTEGER", nullable: false),
                    MonthlyReport = table.Column<bool>(type: "INTEGER", nullable: false),
                    ShowBalance = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    LoginNotifications = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlertThreshold = table.Column<decimal>(type: "TEXT", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    NotifyOnAlert = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    NotifyOnExceed = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptThumbnailUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_UserId_DisplayOrder",
                table: "Accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_UserId_DisplayOrder",
                table: "Categories",
                columns: new[] { "UserId", "DisplayOrder" });
